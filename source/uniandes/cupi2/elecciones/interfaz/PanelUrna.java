...
/**
 * Panel que contiene la informacion de la urna de votos en las elecciones cupi2
 */
...
public class PanelUrna extends JPanel
{
	...
	/**
	 * Dataset de los votantes por genero.
	 */
	 ...
	 * @param urna Urna de la cual se va a mostrar la informacion. urna != null.
	 */
	public void actualizar( Urna urna )
	{
		...
		datosRangoEdad.setValue("55 o más ", urna.calcularTotalVotosEdadMayor());
	}
