...
public class PanelVotar extends JPanel implements ActionListener
{
    ...
    /**
     * Es la lista de opciones de genero.
     */
    ...
    public PanelVotar(DialogoVotar dv)
    {
    	...
    	JLabel lblInfluencia = new JLabel("¿Que medio influencia más en usted para votar por este candidato?");
