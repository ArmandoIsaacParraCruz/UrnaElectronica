...
public class InterfazElecciones extends JFrame
{
	...
	/**
	 * Adiciona un voto a un candidato dependiendo del medio que mas influencia el voto. Registra el genero y el rango de edad del votante.
	...
	public void adicionarVotoCandidato( int numCandidato, String influencia, String genero, String rangoEdad )
	{
		...
		if( numCandidato == 1 )
		{
			...
			if( rangoEdad.equals( "Joven: 18 - 34 años" ) )
			{
		...
		if( numCandidato == 2 )
		{
			...
			if( influencia.equals( "Television" ) )
			{
	...
	/**
	 * Muestra el dialogo de estadisticas de un candidato
